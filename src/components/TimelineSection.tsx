  ...
  return (
    <section className="section-padding">
      <div className="max-w-4xl mx-auto">
        <p className="mono-label text-accent mb-4">THE EDIT</p>
        <h2 className="text-display-sm mb-16">EXPERIENCE</h2>

        <div className="relative">
          {/* Vertical line */}
          <div className="absolute left-[7px] top-0 bottom-0 w-[1px] bg-muted" />
          ...
          <div className="space-y-12">
            {experiences.map((item, i) => (
              <motion.div
                ...
                transition={{ duration: 0.4, delay: i * 0.1, ease: [0.19, 1, 0.22, 1] }}
              >
                {/* Keyframe dot */}
                <div className="absolute left-0 top-1 w-[14px] h-[14px] border-2 border-accent bg-background rotate-45" />
